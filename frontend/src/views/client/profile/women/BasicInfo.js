...
const BasicInfo = () => {
  ...
  let newWBasicInfo = {
    ...
    parent: wBasicInfo?.parent === 1 ? 'Yes' : 'No',
    pregnant: wBasicInfo?.pregnant === 0 ? 'No' : 'Yes'
  };
          ...
          <Grid container>
            <Formik
              ...
              validationSchema={Yup.object().shape({
                ...
                shirt_blouse: Yup.string().required('Please provide shirt blouse'),
                dress: Yup.string().required('Please provide dress'),
                pants: Yup.string().required('Please provide pants'),
                pantsr1: Yup.string().required('Please provide bottom')
              })}
              onSubmit={async (values) => {
                const valueToSubmit = {
                  ...
                  pregnant: values.pregnant === 'Yes' ? 1 : 0
                };
                ...
                return (
                  <Form noValidate onSubmit={handleSubmit}>
                    <Grid container columnSpacing={4} padding="20px">
                      ...
                      {(values.pregnant === 1 || values.pregnant === 'Yes') && (
                        <>
                          <Grid item xs={12}>
                            ...
                            <FormControl fullWidth>
                              <LocalizationProvider dateAdapter={AdapterDayjs}>
                                <DatePicker
                                  ...
                                  value={values.expected_due_date}
                                  onChange={(value) => {
                                    const date = new Date(Date.parse(value));
                                    setFieldValue('expected_due_date', date);
                                  }}
                                  renderInput={(params) => <TextField {...params} />}
                                />
                              </LocalizationProvider>
