                    ...
                    <Grid container spacing={4}>
                      ...
                      >
                        <ImageUpload
                          arg="dsgnImgUrl1st"
                          value={
                            values.dsgnImgUrl1st || 'http://localhost/drapefitlive/assets/men-img/mencustomdesign1.jpg'
                          }
                      ...
                      >
                        <ImageUpload
                          arg="dsgnImgUrl2nd"
                          value={
                            values.dsgnImgUrl2nd || 'http://localhost/drapefitlive/assets/men-img/mencustomdesign2.jpg'
                          }
                          setFieldValue={setFieldValue}
                        />
                        <Typography className="basic-info-sub-title" align="center">
                      ...
                      >
                        <ImageUpload
                          arg="dsgnImgUrl3rd"
                          value={
                            values.dsgnImgUrl3rd || 'http://localhost/drapefitlive/assets/men-img/mencustomdesign3.jpg'
                          }
                          setFieldValue={setFieldValue}
                        />
                        <Typography className="basic-info-sub-title" align="center">
