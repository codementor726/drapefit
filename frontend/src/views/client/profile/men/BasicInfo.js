...
const BasicInfo = () => {
  ...
  const newBasinInfo = {
    ...
    are_you_a_parent: mBasicInfo?.are_you_a_parent === 1 ? 'Yes' : mBasicInfo?.are_you_a_parent === 2 ? 'No' : 'No'
  };
          ...
          <Grid container>
            <Formik
              ...
              validationSchema={Yup.object().shape({
                ...
                birthday: Yup.date()
                  .min(new Date(`01/01/${maxBirthYear}`), 'The year of the birthday is invalid')
                  .max(new Date(`01/01/${minBirthYear}`), 'The year of the birthday is invalid')
                  .typeError('Please provide your birthday')
                  .required('Please provide your birthday'),
                waist: Yup.number().min(1, 'Please provide waist size').required('Please provide waist size'),
                size: Yup.number().min(1, 'Please fill your shirt size').max(7).required('Please fill your shirt size'),
                inseam: Yup.number().min(1, 'Please provide inseam size').required('Please provide inseam size')
              })}
