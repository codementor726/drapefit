                  ...
                  <Grid item xs={12}>
                    <Grid container spacing={4}>
                      <Grid item xs={12} sm={6} md={4}>
                        <ImageUpload
                          arg="img1"
                          value={values.img1 || 'http://localhost/drapefitlive/assets/kid-img/KidGirlCustomDesign1.jpg'}
                      ...
                      <Grid item xs={12} sm={6} md={4}>
                        <ImageUpload
                          arg="img2"
                          value={values.img2 || 'http://localhost/drapefitlive/assets/kid-img/KidGirlCustomDesign2.jpg'}
                          setFieldValue={setFieldValue}
                        />
                        <Typography className="basic-info-sub-title" align="center">
                          Second Design
                      ...
                      <Grid item xs={12} sm={6} md={4}>
                        <ImageUpload
                          arg="img3"
                          value={values.img3 || 'http://localhost/drapefitlive/assets/kid-img/KidGirlCustomDesign3.jpg'}
                          setFieldValue={setFieldValue}
                        />
                        <Typography className="basic-info-sub-title" align="center">
                          Third Design
